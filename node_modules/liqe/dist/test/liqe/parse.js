...
var testQuery = function (t, expectedAst) {
    var ast = (0, parse_1.parse)(t.title);
    t.deepEqual(ast, expectedAst);
};
(0, ava_1.default)('error describes offset', function (t) {
...
(0, ava_1.default)('empty query', function (t) {
...
(0, ava_1.default)('empty query (whitespace)', function (t) {
    t.deepEqual((0, parse_1.parse)('  '), {
        location: {
            end: 0,
            start: 0,
...
(0, ava_1.default)('foo with whitespace at the start', function (t) {
...
(0, ava_1.default)('foo with whitespace at the end', function (t) {
    t.deepEqual((0, parse_1.parse)('foo '), {
        expression: {
            location: {
                end: 3,
